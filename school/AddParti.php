	...
	$level = $_POST['level'];
      ...
      if( ! $db->display($stmnt))
      {
			...
			for( $i=0; $i<$program['Number_of_participants']; $i++ )
		{
		  ...
		  $stmnt='INSERT INTO participants(`Program_id`, `School_id`, `Name`, `Level`) 
		 VALUES (:programid, :schoolid, :name, :level)';
		 $params = array(
		 	':programid' => $Program_id,
		 	':schoolid' => $id,
        		...
        		<div class="col-md-10">
		        	<div class="form-group">
	                    ...
	                    <div class="col-sm-6">
	                        		...
	                        		<?php 
	                        			for( $i=0; $i<$program['Number_of_participants']; $i++ ) {
	                        				echo '<input type="text" required class="form-control" name="name[]" id="" placeholder="Name">';
	                        			}
	                        		?>
			        	...
			        	<div class="form-group">
		                    ...
		                    <div class="col-sm-6">
		                         <select name="level" required class="form-control">
		                             <option value="sj">Sub Juniour</option>
		                            <option value="j">Juniour</option>   
		                            <option value="s">Seniour</option>  
		                        </select>
		                    </div>
		                </div>
	        		</div>
