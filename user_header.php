...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo PATH; ?>/as
    styles.css">
    <!-- JS Core -->
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
              <a class="nav-link" href="http://localhost/ytf/index">Home
                <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/ytf/index">About</a>
            </li>
            <li class="nav-item">
